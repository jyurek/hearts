...
Elm.Card = Elm.Card || {};
Elm.Card.Model = Elm.Card.Model || {};
Elm.Card.Model.make = function (_elm) {
   "use strict";
   _elm.Card = _elm.Card || {};
   _elm.Card.Model = _elm.Card.Model || {};
   if (_elm.Card.Model.values) return _elm.Card.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var cardValueString = function (model) {
      var _p1 = model;
      if (_p1.ctor === "UnknownCard") {
            return "down";
         } else {
            var _p3 = _p1._0;
            var _p2 = _p3.face;
            if (_p2.ctor === "Up") {
                  return A2($Basics._op["++"],$String.toLower($Basics.toString(_p3.suit)),A2($Basics._op["++"],"-",valueString(_p3.value)));
               } else {
                  return "down";
               }
         }
   ...
   var cardString = function (card) {
      var _p4 = card;
      if (_p4.ctor === "UnknownCard") {
            return "card down";
         } else {
            return A2($Basics._op["++"],"card ",cardValueString(card));
         }
   };
   var UnknownCard = {ctor: "UnknownCard"};
   var initialModel = UnknownCard;
   var Card = function (a) {    return {ctor: "Card",_0: a};};
   var KnownCard = F3(function (a,b,c) {    return {face: a,value: b,suit: c};});
   var Down = {ctor: "Down"};
   var Up = {ctor: "Up"};
   var flipOver = function (card) {
      var _p5 = card.face;
      if (_p5.ctor === "Up") {
            return _U.update(card,{face: Down});
         } else {
            return _U.update(card,{face: Up});
         }
   };
   ...
   var King = {ctor: "King"};
   var Ace = {ctor: "Ace"};
   var valueFromInteger = function (i) {
      var _p6 = i + 1;
      switch (_p6)
      {case 1: return Ace;
         case 11: return Jack;
   ...
   var suitFromInteger = function (i) {
      var _p7 = i;
      switch (_p7)
   ...
   var cardFromInteger = function (i) {
      var i$ = i - 1;
      var suit = suitFromInteger(i$ / 13 | 0);
      var value = valueFromInteger(A2($Basics._op["%"],i$,13));
      return Card({value: value,suit: suit,face: Up});
   };
   return _elm.Card.Model.values = {_op: _op
                                   ,Spades: Spades
                                   ,Hearts: Hearts
                                   ,Clubs: Clubs
                                   ,Diamonds: Diamonds
                                   ...
                                   ,cardValueString: cardValueString
                                   ,initialModel: initialModel
                                   ,cardFromInteger: cardFromInteger
                                   ,suitFromInteger: suitFromInteger
                                   ,valueFromInteger: valueFromInteger};
};
Elm.Card = Elm.Card || {};
Elm.Card.Update = Elm.Card.Update || {};
Elm.Card.Update.make = function (_elm) {
   "use strict";
   _elm.Card = _elm.Card || {};
   _elm.Card.Update = _elm.Card.Update || {};
   if (_elm.Card.Update.values) return _elm.Card.Update.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Card$Model = Elm.Card.Model.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var updateCard = F2(function (action,card) {    var _p0 = action;return $Card$Model.Card($Card$Model.flipOver(card));});
   var update = F2(function (action,model) {
      var _p1 = model;
      if (_p1.ctor === "UnknownCard") {
            return $Card$Model.UnknownCard;
         } else {
            return A2(updateCard,action,_p1._0);
         }
   });
   var Flip = {ctor: "Flip"};
   return _elm.Card.Update.values = {_op: _op,Flip: Flip,update: update,updateCard: updateCard};
};
Elm.Card = Elm.Card || {};
Elm.Card.View = Elm.Card.View || {};
Elm.Card.View.make = function (_elm) {
   "use strict";
   _elm.Card = _elm.Card || {};
   _elm.Card.View = _elm.Card.View || {};
   if (_elm.Card.View.values) return _elm.Card.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Card$Model = Elm.Card.Model.make(_elm),
   $Card$Update = Elm.Card.Update.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toClass = $Card$Model.cardString;
   var cardStrings = function (card) {    return _U.list([]);};
   var view = F2(function (address,card) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class(toClass(card)),A2($Html$Events.onClick,address,$Card$Update.Flip)]),
      A2($List.map,$Html.text,cardStrings(card)));
   });
   return _elm.Card.View.values = {_op: _op,view: view,cardStrings: cardStrings,toClass: toClass};
};
Elm.General = Elm.General || {};
Elm.General.make = function (_elm) {
   "use strict";
   _elm.General = _elm.General || {};
   if (_elm.General.values) return _elm.General.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   return _elm.General.values = {_op: _op};
};
Elm.Hand = Elm.Hand || {};
Elm.Hand.Model = Elm.Hand.Model || {};
Elm.Hand.Model.make = function (_elm) {
   "use strict";
   _elm.Hand = _elm.Hand || {};
   _elm.Hand.Model = _elm.Hand.Model || {};
   if (_elm.Hand.Model.values) return _elm.Hand.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Card$Model = Elm.Card.Model.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $General = Elm.General.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var subsetDeck = function (cardNumbers) {
      return {cards: A2($List.map,function (x) {    return {ctor: "_Tuple2",_0: x,_1: $Card$Model.cardFromInteger(x)};},cardNumbers),nextID: 53};
   };
   var initialModel = {cards: _U.list([]),nextID: 1};
   var Model = F2(function (a,b) {    return {cards: a,nextID: b};});
   return _elm.Hand.Model.values = {_op: _op,initialModel: initialModel,subsetDeck: subsetDeck,Model: Model};
};
Elm.Hand = Elm.Hand || {};
Elm.Hand.Update = Elm.Hand.Update || {};
Elm.Hand.Update.make = function (_elm) {
   "use strict";
   _elm.Hand = _elm.Hand || {};
   _elm.Hand.Update = _elm.Hand.Update || {};
   if (_elm.Hand.Update.values) return _elm.Hand.Update.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Card$Model = Elm.Card.Model.make(_elm),
   $Card$Update = Elm.Card.Update.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $General = Elm.General.make(_elm),
   $Hand$Model = Elm.Hand.Model.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var updateMatching = F3(function (matchId,action,_p0) {
      var _p1 = _p0;
      var _p3 = _p1._0;
      var _p2 = _p1._1;
      return _U.eq(matchId,_p3) ? {ctor: "_Tuple2",_0: _p3,_1: A2($Card$Update.update,action,_p2)} : {ctor: "_Tuple2",_0: _p3,_1: _p2};
   });
   var update = F2(function (action,hand) {
      var _p4 = action;
      if (_p4.ctor === "Insert") {
            return _U.update(hand,{cards: A2($List._op["::"],{ctor: "_Tuple2",_0: hand.nextID,_1: _p4._0},hand.cards),nextID: hand.nextID + 1});
         } else {
            return _U.update(hand,{cards: A2($List.map,A2(updateMatching,_p4._0,_p4._1),hand.cards),nextID: hand.nextID});
         }
   });
   var CardAction = F2(function (a,b) {    return {ctor: "CardAction",_0: a,_1: b};});
   var Insert = function (a) {    return {ctor: "Insert",_0: a};};
   return _elm.Hand.Update.values = {_op: _op,Insert: Insert,CardAction: CardAction,update: update,updateMatching: updateMatching};
};
Elm.Hand = Elm.Hand || {};
Elm.Hand.View = Elm.Hand.View || {};
Elm.Hand.View.make = function (_elm) {
   "use strict";
   _elm.Hand = _elm.Hand || {};
   _elm.Hand.View = _elm.Hand.View || {};
   if (_elm.Hand.View.values) return _elm.Hand.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Card$View = Elm.Card.View.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Hand$Model = Elm.Hand.Model.make(_elm),
   $Hand$Update = Elm.Hand.Update.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var viewOne = F2(function (address,_p0) {
      var _p1 = _p0;
      return A2($Card$View.view,A2($Signal.forwardTo,address,$Hand$Update.CardAction(_p1._0)),_p1._1);
   });
   var viewAll = F2(function (address,cs) {
      var _p2 = cs;
      if (_p2.ctor === "[]") {
            return $Html.text("");
         } else {
            if (_p2._1.ctor === "[]") {
                  return A2($Html.div,_U.list([$Html$Attributes.$class("nest")]),_U.list([A2(viewOne,address,_p2._0)]));
               } else {
                  return A2($Html.div,_U.list([$Html$Attributes.$class("nest")]),_U.list([A2(viewOne,address,_p2._0),A2(viewAll,address,_p2._1)]));
               }
         }
   });
   var view = F2(function (address,hand) {    return A2($Html.div,_U.list([$Html$Attributes.$class("hand")]),A2($List.map,viewOne(address),hand.cards));});
   return _elm.Hand.View.values = {_op: _op,view: view,viewAll: viewAll,viewOne: viewOne};
};
